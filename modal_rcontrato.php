      ...
      <div class="modal-body">
        ...
        <form action="procesos/agregar_rcontrato.php" method="post" enctype="multipart/form-data" class="form-horizontal">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal" style="font-size: 12px; padding: 15px;">Cancelar</button>
            <button type="submit" class="btn btn-danger" style="font-size: 12px; padding: 15px;">Renuncia</button>
          </div>
