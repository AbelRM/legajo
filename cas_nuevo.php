          ...
          <form action="procesos/agregar_cas.php" method="POST">
            <div class="card-body">
              ...
              <div class="row form-group">
                ...
                <div class="col-12 col-md-4"><input type="text" id="nombres" name="nombres" class="form-control" required><small class="form-text text-muted">Nombres completos</small></div>

                <div class="col col-md-2"><label for="email-input" class=" form-control-label">Ape. Paterno</label></div>
                <div class="col-12 col-md-4"><input type="text" id="ape_pat" name="ape_pat" class="form-control" required></div>
              </div>

              <div class="row form-group">
                <div class="col col-md-2"><label for="password-input" class=" form-control-label">Ape. Materno</label></div>
                <div class="col-12 col-md-3"><input type="text" id="ape_mat" name="ape_mat" class="form-control" required></div>

                <div class="col col-md-1"><label for="disabled-input" class=" form-control-label">DNI</label></div>
